...
This is a simple library MS for Angular libraries, implementing the
...
1. Create a project folder (you can call it `ms-lib` and rename it later).
1. [Clone](#clone "Clone it from github") or [download](#download "download it from github") the **MS Library seed** into your project folder.
...
```
git clone https://github.com/maspasov/ms-lib.git
cd ms-lib
npm install
npm start
```
...
### Download
[Download the MS Library seed](https://codeload.github.com/cyrilletuzi/angular-ms-lib/zip/master)
...
## What's in the MS Library seed?

The **MS Library seed** contains a similar structure to the [MS seed](https://github.com/angular/MS).
...
The **MS Library seed** includes a directory called `integration` containing a standalone
...
Use your editor to search the project for all instances of `ms-lib` and change it
